...
const ProjectCard = ({ project, reverse }) => (
  <div className={`flex flex-col md:flex-row md:items-center ${reverse ? 'md:flex-row-reverse' : ''} gap-8 mb-14`}>
    <div className="md:w-1/2 w-full">
      <img src={project.image} alt={project.title} className="rounded-xl w-full object-cover shadow-md" />
    </div>
    <div className="md:w-1/2 w-full flex flex-col justify-center">
      ...
      <a href="#" className="text-gray-400 hover:text-white transition text-base inline-block" target="_blank" rel="noopener noreferrer">
...
const Projects = () => (
  <section className="bg-black px-6 md:px-16 py-20 rounded-3xl max-w-[1200px] mx-auto mt-10">
